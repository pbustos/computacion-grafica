...
# \mainpage RoboComp::peopletracker
#
...
#
# Just: "${PATH_TO_BINARY}/peopletracker --Ice.Config=${PATH_TO_CONFIG_FILE}"
#
...
if __name__ == '__main__':
    ...
    try:
        ...
        try:
            ...
            apriltagsserver_proxy = RoboCompAprilTagsServer.AprilTagsServerPrx.uncheckedCast(basePrx)
